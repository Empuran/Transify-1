...
const isConfigured = typeof window !== "undefined" ? !!process.env.NEXT_PUBLIC_FIREBASE_API_KEY : true;
// During build, process.env might be empty. 
...
export { app, auth, db, signInWithCustomToken, signInAnonymously };
